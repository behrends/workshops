...
der Cloud, wie z.B. die sehr umfangreiche Plattform [Replit](https://replit.com). In Replit gibt es mit [Replit AI](https://replit.com/ai) einen integrierten „KI-Assistenten“, der Code generieren und erklären kann, und der in einem interaktiven Chat nutzbar ist.
