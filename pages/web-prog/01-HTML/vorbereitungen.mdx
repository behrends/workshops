...
zum Einsatz (siehe die Abbildung oben). Für diese Themen reichen die
Vorlesungsstunden nicht aus.
...
Wir werden in den späteren Terminen auch etwas Zeit für das gemeinsame
Programmieren haben.
