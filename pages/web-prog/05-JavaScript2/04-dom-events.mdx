...
Einem HTML-Element kann ein sogenannter „_event handler_“ zugewiesen
werden. Dabei handelt es sich in der Regel um eine Funktion (_handler_),
die beim Eintreten eines bestimmten Ereignis (_event_) aufgerufen wird:
