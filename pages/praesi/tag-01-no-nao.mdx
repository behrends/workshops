...
**Interessant ist auch [replit.com mit AI](https://replit.com)**. Dies kann auch kurz mit p5.js oder Java/Python gezeigt werden (AI als Chat und zur Code-Generierung).
