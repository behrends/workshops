...
import MakecodeArcade from '@/components/content/makecode-arcade.mdx';
import P5JS from '@/components/content/p5js.mdx';
...
- 4o: Fragen beantworten, Bilder erkennen und erzeugen, Daten analysieren
  ...
  (--> wir führen den Code in Replit aus)
  ```
-  mit o1-preview (Reasoning), Canvas
</Callout>
