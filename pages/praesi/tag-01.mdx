...
Die Aufgaben sind kurz mit Text in Moodle beschrieben (z.T. auch mit Video) 
...
function draw() {
  ...
  rect(100, 120, 50, 50) // kleines Quadrat oben links
  rect(width/2, height/2, 200, 200) // größeres Quadrat unten rechts
}
```
