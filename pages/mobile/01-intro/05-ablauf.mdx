...
&xrarr; Eigene Recherchen sind beim App-Projekt notwendig (Dokumentation, Videokurse, …)
</Callout>
...
- Android (in Kotlin mit Compose &mdash; ab heute!)
- React Native
...
- Grundlagen der Programmiersprache (Kotlin, JavaScript/TypeScript)
- UI-Elemente und Layout
- Navigation zwischen Bildschirmen
- optional: Daten speichern lokal speichern
- optional: Zugriff auf Geräteeigenschaften (Kamera, GPS, …)
