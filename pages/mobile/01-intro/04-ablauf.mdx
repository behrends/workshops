...
&xrarr; In der Vorlesung werden die Themen nur relativ kurz besprochen, denn es gibt zahlreiche, umfangreiche Themen mit ständigen Änderungen.

&xrarr; Eigene Recherchen sind beim App-Projekt notwendig (Dokumentation, YouTube, KI-Tools, …)
</Callout>
...
- Prinzipien des Frameworks (Komponenten/Widgets, State, …)
- App mit einem Screen: UI-Elemente, Interaktion und Layout
