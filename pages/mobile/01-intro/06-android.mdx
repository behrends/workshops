...
Mit [Android Device Streaming](https://developer.android.com/studio/run/android-device-streaming) lassen sich weitere „echte Smartphones“ (z.B. von Samsumg) in der Cloud für die App-Entwicklung nutzen.
