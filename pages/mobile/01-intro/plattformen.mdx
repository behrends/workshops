...
Möglicherweise gibt es weitere relevante Frameworks, d.h. solche, die von einigen genutzt und weiterentwickelt werden:

- NativeScript &mdash; [nativescript.org](https://nativescript.org/)
- Kotlin Multiplatform Mobile &mdash; [kotlinlang.org/lp/mobile](https://kotlinlang.org/lp/mobile/) 
- capacitator (cross-platform native runtime for web apps by Ionic) &mdash; [capacitorjs.com](https://capacitorjs.com)
- Tauri (mobile coming soon) &mdash; [tauri.app](https://tauri.app)
