...
Wer lieber mit einer lokalen Entwicklungsumgebung arbeiten möchte, 
...
Manchmal ist in der Android-Vorschau ein _full reload_ oder sogar 
ein _hard restart_ notwendig, um die Code-Änderungen zu testen.

<Callout type="info">
Im Oktober 2024 war es noch nicht möglich die Flutter-App aus
Project IDX direkt auf einem „echten“ Android-Gerät zu testen. 
Dazu muss Flutter lokal auf dem Rechner installiert werden.
</Callout>
