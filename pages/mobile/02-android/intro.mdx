...
<Callout type="error" emoji="‼️">
Stand Oktober 2022: Der Guide [„_Build your first app_“](https://developer.android.com/training/basics/firstapp) verweist auf ein Codelab, in dem die App mit Jetpack Compose entwickelt wird. 

Ein Großteil der Guides basiert aber noch auf den Ansätzen ohne Compose, sodass manche Beschreibungen nun inkonsistent oder veraltet sind.

&xrarr; Es scheint im Oktober 2022 so, dass in Zukunft Jetpack Compose mit Kotlin der standardmäßige Ansatz sein wird, um neue native Android-Apps zu entwickeln.
...
- Liste mit mehreren Apps in der Android-Dokumentation: https://developer.android.com/samples (ggf. nach _Compose_ suchen)
...
- Einsteigerkurs mit Kotlin und Compose: https://developer.android.com/courses/android-basics-compose/course
- Mehr zu Compose: https://developer.android.com/jetpack/compose
- Einsteigerkurs mit Kotlin ohne Compose: https://developer.android.com/courses/android-basics-kotlin/course
- Einsteigerkurs mit Java (leider veraltet und nicht mehr zu empfehlen): https://developer.android.com/courses/fundamentals-training/overview-v2
