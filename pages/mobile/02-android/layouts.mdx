...
Im Oktober 2022 zeichnet sich ab, dass Google in Zukunft Compose als den neuen, standardmäßigen Ansatz zur UI-Entwicklung in Android empfehlen wird (z.B. Guide [„_Build your first app_“](https://developer.android.com/training/basics/firstapp) in den Android Developer Docs).
</Callout>
