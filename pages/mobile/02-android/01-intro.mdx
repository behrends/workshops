...
Im ersten Codelab der offiziellen Dokumentation 
...
Diese Änderung ist also schon im Template „_Empty Activity_“ enthalten, aber nicht im ersten Codelab, dass für den Einstieg 
in die Android-Entwicklung empfohlen wird.
</Callout>
...
- [Platform samples mit Code](https://github.com/android/platform-samples) &mdash; Sammlung von Beispiel-Apps zu verschiedenen APIs (Camera, Location, UI, usw.)
...
Templates Java als Programmiersprache gewählt werden (z.B. mit dem Template „_Empty Views Activity_“). 
