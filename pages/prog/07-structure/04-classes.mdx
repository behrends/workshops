...
```js
// Wie bei Objekte kann der Zugriff auf die Werte von Eigenschaften
...
Der Aufruf einer Methode erfolgt mit über ein Objekt:
...
- `static` für statische Instanzvariablen und -Methoden &mdash; siehe [spätere Lektion](/prog/09-misc/static)
- Private Eigenschaften mit getter-/setter-Methoden &mdash; siehe [spätere Lektion](/prog/09-misc/private)
- Vererbung in Klassen &mdash; siehe [spätere Lektion](/prog/09-misc/extends)
