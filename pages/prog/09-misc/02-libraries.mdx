...
Früher haben wir in Node.js bzw. replit.com die Bibliothek `readline-sync`
...
<Callout type="warning">
In `readline-Sync` funktionieren Pfeiltasten bei der
Eingabe nicht und `prompt-sync-plus` unterstützt keine
