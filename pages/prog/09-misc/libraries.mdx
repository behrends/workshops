...
Asynchrone Bibliotheken sind zwar performanter und flexibler als
synchrone, aber dafür etwas schwieriger zu verwenden. Es folgen
eine paar Beispiel-Projekte.
...
Neben `prompts` (siehe oben), gibt es andere Bibliotheken 
für die Eingabe im Terminal, die z.T. zusätzliche Dinge 
ermöglichen (siehe unten). Die Verwendung dieser 
Bibliotheken erfolgt jedoch asynchron mit 
