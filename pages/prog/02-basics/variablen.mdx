...
Mit `var` deklarierte Variablen haben einen Gültigkeitsbereich, 
der sich nicht auf den umgebenden [Block](../glossar#Block)
bezieht (sondern auf die umgebende Funktion):
