...
<Callout type="info">
In Node.js gibt es mit CommonJS und `exports/require` 
...
## Vorbereitungen in replit und Node.js

Um `import`/`export` in replit oder Node.js verwenden 
...
1. Falls noch nicht vorhanden, im Projektordner die Datei `package.json` erstellen: 
  ...
  - In Node.js kann diese mit `npm init` erstellt werden.
