...
- Die wichtige Fragen-/Antworten-Plattform [stackoverflow](https://stackoverflow.com) organisiert eine jährliche Umfrage, bei der u.a. nach [den beliebtesten Programmiersprachen](https://survey.stackoverflow.co/2024/technology#1-programming-scripting-and-markup-languages) gefragt wird (hierbei gehören auch NodeJS und TypeScript zu JavaScript).
