...
Für den zweiten GitHub-Account muss ein SSH-Key auf GitHub vorliegen und lokal in `~/.ssh/config` angepasst werden:
...
Als zweiter GitHub-User das Projekt klonen:
