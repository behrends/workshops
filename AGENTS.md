...
**Workshop areas:**
- `prog/`: General programming fundamentals and a glossary of key terms. JavaScript in the terminal without browser, HTML and CSS.
...
Commit messages typically follow `Area: short summary` (e.g., `Prog: Glossar erweitert`, `Präsi: Add z.ai and minimax.io`). Keep commits focused on one content area. Commit messages should be in German, concise and descriptive but not too verbose. Do not add any "co-authored by" information about coding agents in commit messages or descriptions.
