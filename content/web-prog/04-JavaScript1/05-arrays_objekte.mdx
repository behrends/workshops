...
erfolgen &mdash; mit Strings für die Namen der Eigenschaften und 
dem Zugriff auf Eigenschaften mit `[]` (anstatt `.`):
...
Objekte ohne Klassen haben in JavaScript keinen Bezug 
