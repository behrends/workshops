...
Im nächsten Schritt können wir die App bei Bedarf konfigurieren (Name, Speicherort, usw.). Die meisten Einstellungen können so übernommen werden. <mark>Wir wollen schrittweise eine Todo-App erstellen, daher nennen wir die App **`TodosAndroid`**.</mark>

**Auf GitHub gibt es ein Repository mit der Beispiel-App aus der Vorlesung des letzten Jahres:
https://github.com/behrends/TodosAndroid2025**.
