...
- Wenn die Entwicklung der App in den Teams beginnt, dann ändern wir das Format der Vorlesung: <br/> &rarr; Zeit zum Programmieren und für Fragen und Feedback
- Bei online-Terminen treffen wir uns zu Beginn eines Termins in der Videokonferenz &mdash; auch wenn bei späteren Terminen die Zeit hauptsächlich zum Programmieren genutzt wird.
...
Aspekte besprochen. Durch Teilnahme am Live Coding werden die Inhalte 
angewendet und das Gruppenprojekt ermöglicht die Vertiefung eines 
...
Wir werden in den späteren Terminen einen größeren Teil der Zeit für 
das gemeinsame Programmieren haben.

### Ablauf einer Lerneinheit

Eine Lerneinheit besteht in der Regel aus Live Coding zum Mitmachen
und ggf. mit anschließenden Aufgaben zur Übung:

1. Kurze Vorstellung eines Themas im Kurs anhand der Entwicklung einer kleinen App (Live Coding).
1. Kleine Aufgaben dazu bearbeiten und eigene Ideen ausprobieren.
1. Abschließende Besprechung und Übergang zum nächsten Thema.

Die Lerneinheiten bauen aufeinander auf und ergeben eine kleine App.

<Callout type="warning">
&rarr; Notizen und Links zum Nachschlagen finden sich auf dieser „Workshops“-Webseite.

&rarr; In der Vorlesung werden die Themen nur relativ kurz besprochen, denn es gibt zahlreiche, umfangreiche Themen mit ständigen Änderungen.

&rarr; Eigene Recherchen sind beim App-Projekt notwendig (Dokumentation, YouTube, KI-Tools, …)
</Callout>

## Liste der Frameworks

- Native Entwicklung von Android-Apps in Kotlin mit Compose &mdash; ab heute!
...
- Ionic
- .NET MAUI
- PWAs und weitere Frameworks behandeln wir nicht

Hierfür benötigen wir die ersten 5-6 Termine, sodass wir möglichst
viel Zeit für die Programmierung der App-Projekte haben im „Labor“-Teil haben.
...
In der Vorlesung können die Themen nur kurz und knapp vorgestellt werden — 
eigene Recherchen sind notwendig, da aktuelle Informationen nur in der 
offiziellen Dokumentation eines Frameworks zu finden sind.
</Callout>


Nachdem beispielhafte Frameworks betrachtet wurden, können
die Teams einen Entwicklungsansatz für ihre App-Idee wählen.
Dies sollte nach 3-4 Wochen beginnen.

### Ablauf im „Labor“-Teil

Die Termine nach 3-4 Wochen dienen hauptsächlich zur Programmierung
...
Bei Bedarf können einzelne Aspekte später in kleineren Gruppen
