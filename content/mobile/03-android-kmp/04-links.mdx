...
<Callout>
Falls es zeitlich passt und Interesse besteht, dann können wir 
mit Gemini in Android Studio eine Übersetzung der App in eine
weitere Sprache (z.B. Englisch) generieren lassen.
</Callout>
