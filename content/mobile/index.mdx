...
<Callout type="warning" emoji="✅">
  ...
  relevanten Konzepte mit den Inhalten dieser Seiten abgleichen. Hierbei helfen KI-Coding-Tools, um Apps zügig zu bauen und Konzepte zu erklären.

  **Auf GitHub gibt es für jedes Framework ein Repository mit der
  Beispiel-App aus der Vorlesung des letzten Jahres, z. B. https://github.com/behrends/TodosAndroid2025**.

  &rarr; Die Beispiel-Apps im folgenden Jahr (z. B. 2026) neu erstellen und auf GitHub veröffentlichen.
