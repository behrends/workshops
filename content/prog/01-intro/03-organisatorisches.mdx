...
- **&rarr; eigene Recherchen, das Nacharbeiten und Vertiefung sind im Studium notwendig**
- &rarr; Im Web ist viel Lernmaterial zu finden &mdash; an passender Stelle wird Nützliches empfohlen.
...
- Wenn die Entwicklung der Projekte in den Teams beginnt, dann ändern wir das Format der Vorlesung: <br/> &rarr; Zeit zum Programmieren und für Fragen und Feedback
...
<Callout type="info">
&rarr; Notizen und Links zum Nachschlagen finden sich auf dieser „Workshops“-Webseite. Zu jedem Thema gibt es in Moodle passende Links auf diese Webseite.
