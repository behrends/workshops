...
Erst in ein paar Jahren wird sich zeigen, wie weit es 
möglich sein wird, komplette Apps oder andere Software 
in hoher Qualität zu erstellen, ohne Code schreiben zu müssen.

Manche Systeme wie z.B. die KI-Tools von [Replit](https://replit.com) 
sind dazu schon heute fast vollständig in der Lage.
