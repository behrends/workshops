...
&rarr; Mit den bisher besprochenen Konzepten 
...
Zugriff auf die Elemente erfolgt durch `[` und `]` 
...
Zusätzlich zu seinen Elementen besitzt ein Array 
...
&rarr; Auf dem Whiteboard skizzieren.
</Callout>
...
## Ausblick
 Arrays haben viele Hilfsmethoden in JavaScript, 
...
[späteren Lektion](/prog/js-vertiefung/arrow_functions) behandelt.
