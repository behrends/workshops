...
- [`npm run typecheck`](/prog/09-quality/02-typescript) vor Commits ausführen
- [`npm run lint`](/prog/09-quality/03-eslint) vor Commits ausführen
- [`npm run test`](/prog/09-quality/04-unit-testing-vitest) für zentrale Funktionen ausführen
