...
<Callout type="info">
  **Formatierung als Fundament:** Werkzeuge wie
  ...
  Für VS Code: Prettier-Extension installieren und optional
  `formatOnSave` aktivieren.

  Für Hooks/Agents: vor Commit oder Push mindestens
  `npm run format:check` ausführen (bei Bedarf automatisiert).
</Callout>
