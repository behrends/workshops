...
nicht mehr weiterentwickelt. Dennoch verwenden wir sie hier zu Beginn, da sie stabil und relativ
weit verbreitet ist. Wir nutzen sie hier, um die Eingabe von der Tastatur zu vereinfachen.

Zur Installation Dazu das Terminal in VS Code öffnen und das Projekt zuerst für npm initialisieren:
