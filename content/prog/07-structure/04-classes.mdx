...
&rarr; Funktionen in Klassen werden meistens **Methoden** genannt.
...
- `static` für statische Instanzvariablen und -Methoden &mdash; siehe [spätere Lektion](/prog/js-vertiefung/static)
- Private Eigenschaften mit getter-/setter-Methoden &mdash; siehe [spätere Lektion](/prog/js-vertiefung/private)
- Vererbung in Klassen &mdash; siehe [spätere Lektion](/prog/js-vertiefung/extends)
