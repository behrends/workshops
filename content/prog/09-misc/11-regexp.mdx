...
- `^` &rarr; Anfang des Strings
- `[ ]` beschreibt passende Zeichengruppen (_character class/set_)
- `[A-Za-z0-9]` &rarr; kleine _oder_ große Buchstaben _oder_ Ziffern
- `+` &rarr; ein oder mehrere Zeichen des links vor dem `+` stehenden Musters (hier ein _character set_ in `[ ]`)
- `$` &rarr; Ende des Strings
...
- [regexlearn.com: Playground / Spielplatz](https://regexlearn.com/playground)
- [regexlearn.com: Cheatsheet / Spickzettel](https://regexlearn.com/cheatsheet)
</Callout>
