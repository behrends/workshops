...
Bisher haben wir dafür [readline-sync](https://github.com/anseki/readline-sync)
eingesetzt. Allerdings wird diese Bibliothek schon länger nicht mehr weiterentwickelt.

### Asynchrone prompt-Bibliotheken

Es gibt einige weitere Bibliotheken, um die Eingabe 
in Node.js umzusetzen. Diese bieten oftmals
...
synchronen Bibliotheken wie `readline-sync`.
