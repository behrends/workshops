...
Die modernere Alternative ist die sogenannte
...
das Ergebnis ist dasselbe wie im Beispiel zu
verschachtelten Funktionsaufrufen in
[Teil 1](/prog/03-type-op-func/04-functions):
