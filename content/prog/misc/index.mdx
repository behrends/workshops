...
<Callout type="info">
Die JavaScript-Lektionen wurden in zwei eigene Abschnitte ausgelagert:

- [JavaScript Vertiefung](/prog/js-vertiefung)
- [JavaScript Praxis](/prog/js-praxis)
</Callout>

Zu Beginn eines Termins werden gelegentlich in
höchstens 60 Minuten weiterführende Themen 
behandelt (z. B. OpenAI-API, AI-SDK, Bibliotheken) 
...
&rarr; Neue Funktionalitäten werden in Node.js
